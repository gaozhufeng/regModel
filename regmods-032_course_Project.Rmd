---
title: "Identifing effective variables on miles per gallon for mtcars dataset"
...
#Executive Summary
In this document we have analysed a car dataset consiting of 32 observations and 11 variables. Considering the importance of transmission type we have tried to answer below two questions using explatory data analysis and linear regression:
...
hist(dt$mpg,col="gray",xlab = "miles per gallon",ylab = "Count",main="Fig.1: Histogram of miles per gallon")##figure1
...
This can be done using diffrent r-packages such as ***"leaps"***.  
But for the purpose of this project i have decided to follow the strategy of including variables which could describ other variables as well. 
...
- R2=.6 means 60% of variation of outcome is explained by linear relationship with regressors.
